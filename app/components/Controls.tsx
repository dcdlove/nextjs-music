        ...
        <div className="flex flex-col gap-5 mb-2">
            <div className="relative group">
                ...
                <input
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-white/5 border border-white/10 rounded-2xl text-white placeholder-white/20 focus:outline-none focus:ring-1 focus:ring-cyan-400/50 focus:bg-white/10 transition-all backdrop-blur-md text-sm font-medium tracking-wide"
                />
            </div>
            ...
            <div className="flex items-center justify-between bg-black/20 p-1.5 rounded-2xl backdrop-blur-md border border-white/5">
                {(['default', 'random', 'liked'] as SortMode[]).map(mode => (
                    <button
                        ...
                        className={`flex-1 py-2 px-3 rounded-xl text-xs font-bold uppercase tracking-wider transition-all duration-300 ${sortMode === mode
